    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <!-- Mon profil -->
                <li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Mon profil</a></li>
                <!-- Déconnexion -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{route('objectif.index')}}"><i class="fa fa-dashboard fa-fw"></i> Mes objectifs</a>
                        </li>
                        <li>
                            <a href=""><i class="fa fa-dashboard fa-fw"></i> Tableau d'évaluation</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
